...
test <- RunNICHES(FFPE2,assay = "SCT",species = 'mouse',position.x = 'x',position.y = 'y',
               CellCell = F,CellSystem = F,SystemCell = T,LR.database = 'fantom5',
...
test <- RunNICHES(FFPE2,assay = "SCT",species = 'mouse',position.x = 'x',position.y = 'y',
               CellCell = F,CellSystem = F,SystemCell = F,LR.database = 'fantom5',
...
test <- RunNICHES(FFPE2,assay = "SCT",species = 'mouse',position.x = 'x',position.y = 'y',
               CellCell = T,CellSystem = T,SystemCell = T,LR.database = 'fantom5',
