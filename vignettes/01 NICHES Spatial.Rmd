...
These numeric annotations are satisfactory for the demonstration of NICHES. Any an all metadata can be carried over when NICHES is run, allowing multiple levels of clustering and sub-clustering to be leveraged downstream after micorenvironment calculation.
...
We can further confirm that identified celltype specific signaling mechanisms are indeed specific to tissue regions in which those cells are found:
